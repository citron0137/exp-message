...
import site.rahoon.message.monolithic.common.global.Tx
import site.rahoon.message.monolithic.common.test.IntegrationTestBase
import site.rahoon.message.monolithic.test.infrastructure.TestRepositoryImpl
...
class TestRepositoryIT : IntegrationTestBase() {
    ...
    fun `Self-join 쿼리에서 Filter 적용 확인 - Soft Delete된 엔티티는 조인에서 제외`() {
        ...
        assertTrue(
            foundIds.contains(entity2.id) || foundIds.contains(entity3.id),
