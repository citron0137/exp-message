...
@Table(
    ...
    indexes = [
        Index(name = "idx_iam_refresh_tokens_user_id", columnList = "user_id"),
        Index(name = "idx_iam_refresh_tokens_session_id", columnList = "session_id"),
    ],
)
class CoreRefreshTokenEntity(
    @Id
