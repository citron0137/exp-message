-- Core Phase 3 message persistence tables.
...
CREATE INDEX idx_cv_conversation_messages_channel_id ON cv_conversation_messages (channel_id);
CREATE INDEX idx_cv_conversation_messages_conversation_sequence ON cv_conversation_messages (conversation_id, sequence);
